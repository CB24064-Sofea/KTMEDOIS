...
// =========================================================================
// 2. AUTO-GENERATE NEXT INVOICE ID
// =========================================================================
$next_id = 1; 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_claim'])) {
    ...
    // Safely parse numeric parameters; fall back to 0.00 if non-numeric string data is caught
    ...
    // SQL preparation matching exactly 13 table structural column targets
    ...
    // Using loose string matching parameters ("sssssssssssss") to accept flexible input ranges smoothly
    $stmt->bind_param("sssssssssssss", $do_id, $billing_address, $invoice_num, $description, $invoice_date, $subtotal, $tax, $credit_note, $penalty, $total, $invoice_status, $payment_status, $reason);
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Logo Structure to push it clean to the right side of header-area */
        .logo-container {
            height: 50px;
            display: flex;
            align-items: center;
        ...
        /* =========================================================================
           STYLE UNTUK MODAL POPUP SUBMITTED SUCCESS
           ========================================================================= */
        .modal-overlay {
            position: fixed;
