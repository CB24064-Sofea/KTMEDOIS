...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* FLEX CONTAINER STRUCTURAL SYNC WITH PORTAL SIDEBAR */
        .app-container {
            display: flex;
            flex-direction: row;
            flex-grow: 1;
...
<body>
                    ...
                    <table class="items-table">
                        ...
                        <tbody>
                            <tr style="border-bottom: 8px solid #ffffff;">
                                ...
                                <td>250</td>
                                <td>RM 69.99</td>
                                <td style="font-weight: 600;">RM 7497.50</td>
                            </tr>
                            <tr>
                                <td>Fiber Optic Cable</td>
                                <td>317 m</td>
                                <td>RM 749.99/m</td>
                                <td style="font-weight: 600;">RM 15846.83</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    function printPreviewImage(imagePath) {
        ...
        printWindow.document.write('<php?></head><body>');
