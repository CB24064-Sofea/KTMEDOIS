...
// DESCRIPTION : Management report. OOP InvoiceModel.fetchReportData().
//               exportPDF() via window.print(), exportExcel() via CSV.
// =========================================================================
...
if (isset($_POST['generate'])) {
    $filterApplied = true;
    $model      = new InvoiceModel($conn);            // OOP call
    $reportData = $model->fetchReportData($dateFrom, $dateTo, $status);

    // SDD_CLS_404: exportExcel()
    if ($export === 'excel' && !empty($reportData)) {
        header('Content-Type: text/csv');
        header('Content-Disposition: attachment; filename="KTMeDOIS_Report_' . date('Ymd') . '.csv"');
...
<head>
    ...
    <style>
        ...
        /* SDD_CLS_404: Report filter form */
        ...
        /* SDD_CLS_404: generateReport() button */
        ...
        /* SDD_CLS_404: exportPDF() and exportExcel() */
        ...
        @media print {
            ...
            .filter-card, .export-btns, .page-header .ktmb-logo { display:none !important; }
            ...
            <div class="card filter-card">
                ...
                <form method="POST" action="generate_report.php">
                    <div class="filter-grid">
                        ...
                        <!-- SDD_CLS_404: RQ37 Select Report Status -->
                        <div class="form-group">
                        ...
                        <!-- SDD_CLS_404: RQ39 Generate Report button -->
                        <div class="form-group">
