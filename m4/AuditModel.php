...
class AuditModel {
    ...
    public function writeLogEntry($staffId, $actionType, $invoiceId) {
        ...
        $stmt = $this->db->prepare(
            "INSERT INTO audit_log (user_ID, invoice_ID, action, record_ID)
             VALUES (?, ?, ?, ?)"
        );
